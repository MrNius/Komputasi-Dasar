...
print(bisection_rekursif(f, kiri1, kanan1))
print()
# Tidak ada akar
print('Akar fungsi pada selang [' + str(kiri2) + ',' + str(kanan2) + '] =')
print(bisection_rekursif(f, kiri2, kanan2))
print()

## Persamaan trigonometri
# Ada akar
print('Akar fungsi pada selang [' + str(kiri3) + ',' + str(kanan3) + '] =')
print(bisection_rekursif(g, kiri3, kanan3))
print()
# Tidak ada akar
print('Akar fungsi pada selang [' + str(kiri4) + ',' + str(kanan4) + '] =')
print(bisection_rekursif(g, kiri4, kanan4))
print()
